...
func NewRouter(
	...
	protected.Use(authMiddleware.RequireAuth())
	{
		...
		protected.GET("/documents/:id/revisions", documentHandler.ListDocumentRevisions)
		protected.GET("/documents/:id/revisions/diff", documentHandler.GetDocumentRevisionDiff)
		protected.POST("/documents/:id/revisions/:revision_id/rollback", documentHandler.RollbackDocumentRevision)
